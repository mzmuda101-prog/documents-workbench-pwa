...
const I18N = {
  pl: {
    ...
    inlineEditHint: "Enter — akapit · Shift+Enter — linia · Backspace — scal · Tab — lista · Ctrl+Tab — nagłówek · Ctrl+B/I/U — styl",
    ...
    placeholdersHint: "Pola w formacie {{nazwa}} — skanuj, wypełnij, zapisz plik. Szczegóły w „Skróty i informacje”.",
  ...
  en: {
    ...
    inlineEditHint: "Enter — paragraph · Shift+Enter — line · Backspace — merge · Tab — list · Ctrl+Tab — heading · Ctrl+B/I/U — style",
    ...
    placeholdersHint: "Fields use {{name}} — scan, fill in, save the file. See Shortcuts & tips for details.",
